...
import '../features/onboard/domain/models/new_on_boarding_model.dart';

class AppConstants {
  static const String appName = 'كنز';
  ...
  static List<LanguageModel> newLanguages = [
    LanguageModel(imageUrl: Images.englishLan, languageName: 'English', countryCode: 'US', languageCode: 'en'),
    LanguageModel(imageUrl: Images.arabicLan, languageName: 'عربى', countryCode: 'SA', languageCode: 'ar'),
  ];
