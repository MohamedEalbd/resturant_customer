...
import 'package:stackfood_multivendor/features/address/widgets/text_field.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<MyAddressController>(
      builder: (controller) => Scaffold(
        ...
        body: Container(
          margin: EdgeInsets.only(right: 16.w, left: 16.w, bottom: 40.h),
                  ...
                  children: [
                    ...List.generate(controller.words.length, (index) {
                      return GestureDetector(
                        onTap: () {
                          controller.changeContainer(index);
                        },
                        child: Container(
                          height: 32.h,
                          width: 44.w,
                          ...
                          decoration: BoxDecoration(
                            color: controller.currentIndex == index
                                ? Color(0xff7C0631).withOpacity(0.3)
                                : Colors.white,
