...
class MyOrderRunning extends StatelessWidget {
  const MyOrderRunning({super.key, required this.myOrders});
        ...
        child: ListView.separated(
          ...
          itemBuilder: (_, index) {
            return GestureDetector(
              onTap: () {
                Get.to(() => MyOrderDetails(myOrder: myOrders[index]));
              },
              child: Container(
                height: 72.h,
                width: 357.w,
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(6.r),
                        color: Color(0xff7C0631).withOpacity(0.3),
                      ),
                      child: Text(
