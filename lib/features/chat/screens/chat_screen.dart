    ...
    return GetBuilder<MyChatController>(
      builder: (controller) => Scaffold(
            ...
            child: TextFormField(
              decoration: InputDecoration(
                ...
                prefixIcon: Container(
                  ...
                  child: Image.asset(Images.imageChat2),
                ),
                suffixIcon: Image.asset(Images.sendChat2),
              ),
            ),
          ),
        ),
          ...
          title: Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Image.asset(Images.icon_chat_p),
              ),
            ],
          ),
        ),
        body: ListView.separated(
          ...
          itemBuilder: (_, index) {
            return Align(
              alignment: controller.chats[index].isMe == true
                  ? Alignment.centerLeft
                  : Alignment.centerRight,
              child: Column(
                spacing: 8.h,
                crossAxisAlignment: controller.chats[index].isMe == true
                ...
                children: [
                  ...
                  Directionality(
                    textDirection: controller.chats[index].isMe == true
                        ? TextDirection.ltr
                        : TextDirection.rtl,
                    child: Row(
                      spacing: 8.w,
                      children: [
                        Container(
                          ...
                          child: Image.asset(controller.chats[index].image),
                        ),
                        Container(
                          height: 31.h,
                          width: 151.w,
                          decoration: BoxDecoration(
                            borderRadius: controller.chats[index].isMe == true
                                ? BorderRadius.only(
