...
import '../features/language/screens/new_language_screen.dart';
import '../features/onboard/screens/new_onboarding_screen.dart';
...
class RouteHelper {
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: language, page: () => NewLanguageScreen()),
    GetPage(name: onBoarding, page: () => NewOnboardingScreen()),
